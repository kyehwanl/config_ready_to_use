...
find $PWD -name '*.[ch]' -o -name '*.p[yo]' -o -name '*.go' | grep -v 'test_install' | grep -v 'tools' | ctags -R -L -
find $PWD -name '*.[ch]' -o -name '*.p[yo]' -o -name '*.go' | grep -v "test_install" | grep -v 'tools' > cscope.files
